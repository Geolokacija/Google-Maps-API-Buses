...
var ti = {
    ...
    wordSeparators: "â€“â€”ج¶آ­ث—â€œâ€‌â€‍ _-.()'\""
};
ti.SERVER = typeof window == "object" ? 1 : !0, typeof cfg == "object" && cfg.defaultCity == "klaipeda" && (ti.transportRoutes = function(a, b) {
    ...
    var d = (a || "").toLowerCase(),
        e = d.split(""),
        f, g = ti.accent_map;
    for (var h = e.length; --h >= 0;) c && e[h] == "إ¾" ? (e[h] = "zh", d = !1) : (f = g[e[h]]) ? (e[h] = f === !0 ? "" : f, d = !1) : b === !0 && e[h] === " " && (e[h] = "", d = !1);
...
jq(window).bind("resize", function(a) {
    ...
    if (typeof mobile == "undefined" || typeof a != "undefined") {
        ...
        var b = null,
            c;
        cfg.city.showAllDirections ? (c = ti.fGetRoutes(pg.schedule.city, pg.schedule.transport, pg.schedule.num, pg.schedule.dirType), $("aDir2").style.display = "none", $("aDir1").innerHTML = $("aDir1").innerHTML.replace("â–¼", "")) : c = ti.fGetRoutes(pg.schedule.city, pg.schedule.transport, pg.schedule.num, null, !0, null);
            ...
            for (d = 0, O = t.length; d <= O; d++) {
                ...
                if (d > 0 && (d === O || Z.workday != t[d - 1].workday)) {
                    ...
                    if (cfg.defaultCity === "tallinna-linn")
                        for (var _ = 0; _ < w - W; _++) l.push("<tr><th>â€”</th><td></td></tr>");
    ...
    if (pg.inputStop == "unknown") setTimeout(function() {
        ...
        var v = "<table id=\"tblDepartingRoutes\" class=\"routes-list\" cellpadding=\"0\" cellspacing=\"0\"><tbody><tr><th colspan=\"2\">MarÅ¡rutas</th><th class=\"name\">Kryptis</th><th class=\"time\">Laikas</th></tr>";
